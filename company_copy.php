...
?>
<?php
$query1 = "SELECT * FROM copy_company";
...
<body>
    ...
    <h1 style="text-align:center;margin-top:50px;">Company Copy Trading</h1>
    <div class="row">
                          ...
                          <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                              <ul>
                                ...
                                <li><a id="active" href="company_copy.php">Company Trading</a></li>
  ...
  <div class="col-lg-8 col-sm-12">
    ...
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm rwd-table" cellspacing="0" width="100%">
      <thead>
        ...
        echo " <tr>
      <td >{$row_res['full_name']}</td>
      <td >{$row_res['state_of_residence']}</td>
      <td >{$row_res['account_equity']}</td>
      <td >{$row_res['company_name']}</td>
          <td >{$row_res['phone_number']}</td>
          <td >{$row_res['trading_platform']}</td>
          <td >{$row_res['copy_company_trading_details']}</td>
          <td >{$row_res['copy_company_password']}</td>
