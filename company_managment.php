...
?>
<?php
$query1 = "SELECT * FROM company_managment";
...
<body>
    ...
    <h1 style="text-align:center;margin-top:50px;">Company managment trading</h1>
    <div class="row">
                          ...
                          <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                              <ul>
                                ...
                                <li><a id="active" href="company_managment.php">Company Account</a></li>
  ...
  <div class="col-lg-8 col-sm-12">
    ...
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm rwd-table" cellspacing="0" width="100%">
      ...
      <td >{$row_res['state_of_residence']}</td>
          ...
          <td >{$row_res['company_manage_trading_details']}</td>
          <td >{$row_res['company_manage_password']}</td>
