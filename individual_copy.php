...
<body>
    ...
    <h1 style="text-align:center;margin-top:50px;">Individual Copy Trading</h1>
    <div class="row">
                ...
                <ul>
                  ...
                  <li class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu">
                      <ul>
                        <li>
                          <a id="active" href="individual_copy.php">Individual Trading
                          </a>
                        </li>
  ...
  <div class="col-lg-8 col-sm-12 table-responsive">
    ...
    <td >{$row_res['account_equity']}</td>
        ...
        <td >{$row_res['copy_indiv_trading_details']}</td>
        <td >{$row_res['copy_indiv_password']}</td>
