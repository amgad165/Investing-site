...
$query2 = "SELECT * FROM company_managment";
...
<h1 style="text-align: center;">individual managment Details</h1>
<?php
...
echo "<div class='single_feature'>";
  echo "<div class='single_feature_part'>";
    ...
    echo "<h3>Name : {$row_res['individual_name']}</h3>";
    echo "<h3>State of residence : {$row_res['state_of_residence']}</h3>";
...
<div  class="col-sm-6 col-lg-6">
<h1 style="text-align: center;">Company managment Details</h1>
...
echo "<div class='card-body'>";
  echo "<div class='single_feature'>";
    echo "<div class='single_feature_part'>";
      ...
      echo "<h3>Name : {$row_res2['name']}</h3>";
      echo "<h3>State of residence : {$row_res2['state_of_residence']}</h3>";
