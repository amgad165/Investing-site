...
<body>
    ...
    <h1 style="text-align:center;margin-top:50px;">Bootcamp Class</h1>
    <div class="row">
                        ...
                        <ul>
                          ...
                          <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                              <ul>
                                <li>
                                <a id="active" href="bootcamp.php">Bootcamp Class</a>
                                </li>
                                <li>
      ...
      <thead>
        <tr>
          ...
          while ($row_res = mysqli_fetch_array($results)){
            if ($row_res['class']=='Bootcamp') {
              // code...

        echo " <tr>
      <td >{$row_res['full_name']}</td>
          <td>{$row_res['state']}</td>
          <td >{$row_res['trade_level']}</td>
          <td >{$row_res['gender']}</td>
